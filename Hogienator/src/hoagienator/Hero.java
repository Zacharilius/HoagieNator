...
public class Hero {
	...
	// How many hearts the hero should start with. The desired value should be one less due to 0.
	protected int startingHearts = 2;
	
	// totalLife is the max number of hearts the player has.
	protected int totalLife = startingHearts;
		
	// lastCheckedLife is the total number of hearts last printed on the screen..
	...
	// lifesPresent is the current number of filled hearts last printed on the screen.
	protected int livesPresent = startingHearts;
	
	// This is the current number of guns the player has - Not the types of guns the player has.
